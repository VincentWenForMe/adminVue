 ...
 * and endColumn to delimit what part of the tables is used. The lineDelimiter and
 ...
 *
 * - tables : String|HTMLElement
 * A HTML tables or the id of such to be parsed as input data. Related options ara startRow,
 * endRow, startColumn and endColumn to delimit what part of the tables is used.
 */
...
(function (Highcharts) {
	...
	init: function (options, chartOptions) {
		...
		// Parse and interpret
			...
			// Parse a HTML tables if options.tables is given
			this.parseTable();
